...
public class TestGame extends Test {
	...
	public void run() {
		this.runTest("Nombre de joueurs", test.TestGame::testNbPlayers);
		this.runTest("Accès aux joueurs", test.TestGame::testGetPlayer);
		this.runTest("Autres joueurs (nombre)", test.TestGame::testOtherPlayersSize);
		this.runTest("Autres joueurs (noms)", test.TestGame::testOtherPlayersNames);
		this.runTest("Nombre de cartes dans les piles de réserve", test.TestGame::testNbCardsInSupplies);
		this.runTest("Nombre de piles de réserve disponibles", test.TestGame::testNbAvailableSupplies);
		this.runTest("Trouver une carte de la réserve", test.TestGame::testGetFromSupply);
		this.runTest("Trouver une carte absente de la réserve", test.TestGame::testGetNotInSupply);
		this.runTest("Retirer une carte de la réserve", test.TestGame::testRemoveFromSupply);
		this.runTest("Retirer une carte absente de la réserve", test.TestGame::testRemoveNotInSupply);
		this.runTest("Lister les piles de réserve non vides", test.TestGame::testNbAvailableSupplies);
		this.runTest("Fin de partie (3 piles vides)", test.TestGame::testEndGame3Stack);
		this.runTest("Fin de partie (Provinces)", test.TestGame::testEndGameProvince);
	}

	public static void main(String[] args) {
		test.TestGame t = new test.TestGame();
		t.run();
		t.showResults();
	}
}
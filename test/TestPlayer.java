...
public class TestPlayer extends Test {
	...
	public void run() {
	    this.runTest("Constructeur de Player", test.TestPlayer::testPlayerConstructor);
	    this.runTest("Incrémentation des compteurs", test.TestPlayer::testIncrements);
	    this.runTest("Piocher une carte", test.TestPlayer::testDrawCard);
	    this.runTest("Liste des cartes en main", test.TestPlayer::testCardsInHand);
	    this.runTest("Liste de toutes les cartes", test.TestPlayer::testTotalCards);
	    this.runTest("Points de victoire", test.TestPlayer::testVictoryPoints);
	    this.runTest("Cartes Trésor en main", test.TestPlayer::testGetTreasureCards);
	    this.runTest("Jouer une carte", test.TestPlayer::testPlayCard);
	    this.runTest("Gagner une carte", test.TestPlayer::testGain);
		this.runTest("Acheter une carte", test.TestPlayer::testBuyCard);
		this.runTest("Acheter une carte trop chère", test.TestPlayer::testBuyCardTooExpensive);
		this.runTest("Acheter une carte sans buy", test.TestPlayer::testBuyCardNoBuys);
	}

	public static void main(String[] args) {
		test.TestPlayer t = new test.TestPlayer();
		t.run();
		t.showResults();
	}
}
